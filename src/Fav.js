...
export default function Fav(props) {
    ...
    const notFav = (
        <div className="d-flex flex-row justify-content-center mt-3 mb-3">
            <button type="button" className="btn btn-outline-danger" onClick={() => makeFav()}>
    ...
    const fav = (
        <div className="d-flex flex-row justify-content-center mt-3 mb-3">
            <button type="button" className="btn btn-danger" onClick={() => makeFav()}>
    ...
    if (favState === true) return fav
    if (favState === false) return notFav
